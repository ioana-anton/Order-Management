...
CREATE TABLE `comandaprodus` (
  ...
  CONSTRAINT `idOrder` FOREIGN KEY (`idOrder`) REFERENCES `comanda` (`id`),
...
INSERT INTO `comandaprodus` VALUES (1,NULL,NULL,3),(2,3,1,5),(3,3,3,6),(4,3,6,2),(5,4,3,2),(6,4,6,1);
...
-- Dump completed on 2021-04-21  8:45:03
